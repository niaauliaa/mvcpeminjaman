...
<div class="container">
    ...
    <form action="<?= BASE_URL;?>/Pinjam/cari" method="post" class= "d-flex" style="margin-right: 0.5rem;">
        <input type="text" name="search" id="" class="form-control" style="border: solid 1px grey; margin-right: -0.1rem" placeholder="Cari Barang...">
                ...
                <tr>
                  ...
                  <td>
                    <?php
                        ...
                        if ($selisih_hari == 0 || $selisih_hari == 1 && $date>= $tgl_kembali) {
                        ...
                        }elseif ( $selisih_hari > 2 && $date>= $tgl_kembali) {
                        $status = "sudah kembali" ;
